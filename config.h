...
static const char *fonts[]          = { FONT ":size=10:antialias=true" };
static const char dmenufont[]       = FONT ":size=10:antialias=true";
...
static const int DEFAULT_MASTERS_COUNT = 1;    /* number of clients in master area */
...
static const char *calccmd[]  = { TERMINAL, "-n", "st-calc", "-f", FONT ":size=16", "-g", "50x20", "-e", "bc", "-lq", NULL };
...
static Key keys[] = {
  ...
  { MODKEY,                       XK_i,      change_masters_count,     {.i = +1 } },
  { MODKEY,                       XK_d,      change_masters_count,     {.i = -1 } },
  { MODKEY,                       XK_h,      setmfact,       {.f = -0.05} },
  { MODKEY,                       XK_l,      setmfact,       {.f = +0.05} },
  { MODKEY,                       XK_Return, zoom,           {0} },
  { MODKEY,                       XK_Tab,    view,           {0} },
  { MODKEY|ShiftMask,             XK_c,      kill_selected_client,     {0} },
